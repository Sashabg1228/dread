...
#define HAND_DOWN_GPIO_Port GPIOA
#define HAND_DOWN_EXTI_IRQn EXTI2_IRQn
#define HAND_UP_Pin GPIO_PIN_3
#define HAND_UP_GPIO_Port GPIOA
#define HAND_UP_EXTI_IRQn EXTI3_IRQn
#define WEAPON_Pin GPIO_PIN_4
#define WEAPON_GPIO_Port GPIOA
#define WEAPON_EXTI_IRQn EXTI4_IRQn
